  ...
  return (
    <section className='max-w-7xl max-auto'>
        <div>
            ...
            <p className='mt-2 text-[#666e75] text-[16px] mx-w[500px]'>Browse through a  collection of imaginative & visually stunning images generated by DALL-E AI</p>
        </div>
            ...
            {loading ? (
                ...
                <div className='grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3'>
                    {searchText ? (
                        <RenderCards
                        data={searchResults}
                        title="No Search Results Found , You Can Create Your Own Post Using Create Button On Top-Right-Corner"/>
                    ):(
                        <RenderCards
                        data={allPosts}
                        title="No Posts"/>
